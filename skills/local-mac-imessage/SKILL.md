...
Configure in `.env`:
```bash
ALLOWED_PHONE_NUMBERS=+919945694034,+917259019273,user@example.com
```

- Comma-separated list of phone numbers and/or Apple ID emails
- Phone numbers should be in E.164 format (e.g. `+919945694034`)
- Whitespace is automatically trimmed
- If not set or empty, all recipients are allowed

**Example:** If `ALLOWED_PHONE_NUMBERS=+919945694034`, attempting to send to any other number will fail with:
```
