...
After producing the report, write it to `.cache/mac-storage-YYYY-MM-DD.md` in the current working directory using today's date.
...
Example path: `.cache/mac-storage-2026-03-21.md`
